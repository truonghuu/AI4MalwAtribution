...
if __name__ == '__main__':
    ...
    # with (zipfile.ZipFile('/media/khan/CH SSD/43k_malign_dataset_reports-23k_ok.zip', 'r')) as zipper:
    with (zipfile.ZipFile('E:\\43k_malign_dataset_reports-23k_ok.zip', 'r')) as zipper:
