...
if __name__ == "__main__":
    ...
    parser.add_argument("-m",help="Path to folder with malicious numpy files. e.g E:\\sortedNpy\\[TA0002] Execution")
    parser.add_argument("-b", help= "Path to folder with benign numpy files")
    # parser.add_argument("-t", help="Tactic that you are generating data for. e.g Execution")

    args = parser.parse_args()
    POSITIVE_PATH = args.b
    NEGATIVE_PATH = args.m
    # TACTIC = args.t
