...
def load_data(fold, model):
    ...
    if fold == 0: 
        X_test, y_test = np.load(f'./x_train_{fold}.npy'), np.load(f'./y_train_{fold}.npy')
        a,a2 =  np.load(f'./x_train_{1}.npy'), np.load(f'./y_train_{1}.npy')
        b,b2 =  np.load(f'./x_train_{2}.npy'), np.load(f'./y_train_{2}.npy')
        c,c2 =  np.load(f'./x_train_{3}.npy'), np.load(f'./y_train_{3}.npy')
        d,d2 =  np.load(f'./x_train_{4}.npy'), np.load(f'./y_train_{4}.npy')
        X_train = np.concatenate((a,b,c,d),axis=0)
        y_train = np.concatenate((a2,b2,c2,d2),axis=0)
    if fold == 1:
        X_test, y_test = np.load(f'./x_train_{fold}.npy'), np.load(f'./y_train_{fold}.npy')
        a,a2 =  np.load(f'./x_train_{0}.npy'), np.load(f'./y_train_{0}.npy')
        b,b2 =  np.load(f'./x_train_{2}.npy'), np.load(f'./y_train_{2}.npy')
        c,c2 =  np.load(f'./x_train_{3}.npy'), np.load(f'./y_train_{3}.npy')
        d,d2 =  np.load(f'./x_train_{4}.npy'), np.load(f'./y_train_{4}.npy')
        X_train = np.concatenate((a,b,c,d),axis=0)
    ...
    if fold == 2:
        X_test, y_test = np.load(f'./x_train_{fold}.npy'), np.load(f'./y_train_{fold}.npy')
        a,a2 =  np.load(f'./x_train_{1}.npy'), np.load(f'./y_train_{1}.npy')
        b,b2 =  np.load(f'./x_train_{0}.npy'), np.load(f'./y_train_{0}.npy')
        c,c2 =  np.load(f'./x_train_{3}.npy'), np.load(f'./y_train_{3}.npy')
        d,d2 =  np.load(f'./x_train_{4}.npy'), np.load(f'./y_train_{4}.npy')
        X_train = np.concatenate((a,b,c,d),axis=0)
        y_train = np.concatenate((a2,b2,c2,d2),axis=0)
    if fold == 3:
        ...
        a,a2 =  np.load(f'./x_train_{1}.npy'), np.load(f'./y_train_{1}.npy')
        b,b2 =  np.load(f'./x_train_{2}.npy'), np.load(f'./y_train_{2}.npy')
        c,c2 =  np.load(f'./x_train_{0}.npy'), np.load(f'./y_train_{0}.npy')
        d,d2 =  np.load(f'./x_train_{4}.npy'), np.load(f'./y_train_{4}.npy')
        X_train = np.concatenate((a,b,c,d),axis=0)
        y_train = np.concatenate((a2,b2,c2,d2),axis=0)
    if fold == 4:
        ...
        b,b2 =  np.load(f'./x_train_{2}.npy'), np.load(f'./y_train_{2}.npy')
        c,c2 =  np.load(f'./x_train_{3}.npy'), np.load(f'./y_train_{3}.npy')
        d,d2 =  np.load(f'./x_train_{0}.npy'), np.load(f'./y_train_{0}.npy')
        X_train = np.concatenate((a,b,c,d),axis=0)
        y_train = np.concatenate((a2,b2,c2,d2),axis=0)
    print("Done")
    print(X_train.shape)
...
def train_classic(logger, args):
    ...
    for fold in range(-1, 4):
        ...
        if args.model == 'XGBC':
            ...
            if fold == -1:
                with open(f"LGBM.h5", 'wb') as file:
